...
public class Cls_jy {
	private  Logger log = Logger.getLogger(Cls_jy.class);
/**
 * Cls_jy 构造子注解。
 */
public Cls_jy() {
 ...
 * 32 结果描述
 */
public  String zjgl_chx(String lshh, String org_code) throws Cls_exception, java.net.UnknownHostException {
	...
	try
	{
		...
		String gbs =new String(s.getBytes("ISO-8859-1"),"GB2312");
...
public  String  zjgl_chzh(String lshh, String chzhlshh, String org_code, String jyje, String jydate) throws Cls_exception, IOException {
    log.error("订单发起冲正："+lshh+"冲正流水号"+chzhlshh);
	char c;
	String gbs = null ;
	String s ;
	String str =null;
	...
	log.error("订单发起冲正："+lshh+"冲正流水号"+chzhlshh+",返回："+serverResponse);	
	return serverResponse;
}
/**
 * 此处插入方法说明。
...
public  String zjgl_kk(String lshh, String org_code,String jyje,String jydm) throws Cls_exception, IOException {
	...
	log.error("订单发起扣款交易:"+lshh+",交易代码："+jydm);
	char c;
	String s ;
	String gbs = null ;
	String str =null;	
	...
	try
	{
     ...
     log.error("订单发起扣款交易:"+lshh+",返回:"+serverResponse);
     return serverResponse;
