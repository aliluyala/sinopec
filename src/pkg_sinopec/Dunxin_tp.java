...
public class Dunxin_tp {
	//private static String wj = "/oracle/middleware/user_projects/domains/base_domain/servers/AdminServer/upload/sinopec/sendmsg_tp.ini";
	...
	public static void main(String[] args) {
		//String nr = "您预定了1班次,2到3,4张汽车票，请核对信息，等待后台出票。出票后短信通知您。";
		try {
			 //String str = SendXx("13853308806",nr,"62");
